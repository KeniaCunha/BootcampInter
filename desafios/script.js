...
if(n >= 1 && n <= 34){
  ...
  const extrair = texto.substr(0,n);

  const letraMaiuscula = extrair.toUpperCase(texto);
...
let T1 = parseInt(line.split(',')[0]);
let T2 = parseInt(line.split(',')[1]);
let T3 = parseInt(line.split(',')[2]);
let T4 = parseInt(line.split(',')[3]);
